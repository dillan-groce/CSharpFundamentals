...
namespace _02_ReferenceTypes
{
    ...
    public class ReferenceTypes
    {
        ...
        public void ReferenceTypeVariables()
        {
            ...
            string firstName1 = "Dillan";
            string lastName = "Groce";
            concatenatedFullName = firstName1 + " " + lastName; //--Dillan Groce
            Console.WriteLine(concatenatedFullName);

            //--Interpolation
            string interpolatedFullName = $"{firstName1} {lastName}"; //--Dillan Groce
            Console.WriteLine(interpolatedFullName);

            //--Collections
            //--List
            List<string> listOfStrings = new List<string>();
            listOfStrings.Add(firstName1);
            listOfStrings.Add(lastName);

            //--Array
            string[] arrayOfStrings = new string[8];
            string[] anotherArrayOfStrings = { firstName1, lastName };
